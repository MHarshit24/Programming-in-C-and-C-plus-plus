...
void Wizard::setdistFactor(int newdistFactor)
{
    distFactor = newdistFactor;
}

void Unicorn::setflying_capacity(int newflying_capacity)
{
    flying_capacity = newflying_capacity;
}

void Dragon::setattacking_capacity(int newattacking_capacity)
{
    attacking_capacity = newattacking_capacity;
}
...
int Unicorn::getflying_capacity()
{
    return flying_capacity;
}

int Dragon::getattacking_capacity()
{
    return attacking_capacity;
}